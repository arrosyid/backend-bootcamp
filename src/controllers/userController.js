...
class UserController {
    ...
    async activateUser(req, res, next) {
        ...
        try {
            // Add role check if only admins should activate
            // if (req.user.role.toLowerCase() !== 'admin') {
            //     return res.status(403).json({ success: false, message: 'Forbidden: Only admins can activate users.' });
            // }
    ...
    async deleteUser(req, res, next) {
        ...
        try {
             // Add role check if only admins should delete
            // if (req.user.role.toLowerCase() !== 'admin') {
